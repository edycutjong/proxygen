...
/**
 * E2E: Demo Mode Verification — Proxygen Dashboard
 *
 * Verifies the dashboard works without external dependencies:
 *   - No Ace Data Cloud API keys
 *   - No OOBE SAP keys
 *   - No Solana wallet
 *   - Agent runs in demo mode with mock data
 */
...
test.describe("Demo Mode", () => {
  ...
  test("should have correct page title", async ({ page }) => {
    ...
    expect(title.toLowerCase()).toContain("proxygen");
  });
